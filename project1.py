...
def user_input_features():
    ...
    remaining_contract = st.sidebar.number_input("Залишок контракту/remaining_contract", min_value=0.0, max_value=100.0, step=0.01, key='reamining_contract')
    ...
    download_over_limit = st.sidebar.number_input("Кількість перевищеннь ліміту скачування?/download_over_limit", min_value=0, max_value=100, step=1, key='download_over_limit')
